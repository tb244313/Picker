...
@interface ViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,JJPhotoDelegate,XWImagePickerSheetDelegate>{
...
- (void)viewDidLoad {
    ...
    self.pickerCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 100, [UIScreen mainScreen].bounds.size.width, (((float)[UIScreen mainScreen].bounds.size.width-64.0) /4.0 +20.0)* ((int)(_arrSelected.count)/4 +1)+20.0) collectionViewLayout:layout];
    ...
    self.pickerCollectionView.backgroundColor = [UIColor redColor];
